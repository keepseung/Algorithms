...
public class 뱀 {
    ...
    public static int simulate(){
        ...
        arr[x][y] =2;// 뱀이 존재하는 위치는 2로 표현
        int direction = 2;// 처음에는 동쪽을 보고 있음
        int time = 0; // 시작한 뒤에 지난 초 시간
        int index= 0; // 다음에 회전할 정보

        // 뱀이 차지하고 있는 위치 정보(꼬리가 있음)
